...
export default function Contacts(props) {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_vx91s05", "template_jvuox4r", form.current, '6UYIQMFH8XnoaU_1J')
      .then((result) => {
  ...
  return (
    <motion id={props.id} className={style.contacts__container}>
      ...
      <AnimatePresence>
        {showContactModal && (
          <motion.div className={style.contact__fabmodal} layoutId={2}>
            <motion.div className={`d-flex`}>
              <motion.h2>Contact me</motion.h2>
              <motion.button className={`float-end`} onClick={() => setShowContactModal(false)}>
            ...
            <Container>
              <Row >
                <Col sm>
                  ...
                  <Row>
                    <Col sm={1}>
                      <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><title></title><path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"></path></svg>
                    </Col>
                    <Col sm="auto">ajaxecho3@gmail.com</Col>
                  </Row>
                  <Row>
                    <Col sm={1}>
                      <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z"></path></svg>
                    </Col>
